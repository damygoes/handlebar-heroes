...
const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        'group/bento row-span-1 flex flex-col justify-between space-y-4 rounded-xl bg-border p-4 shadow-input transition duration-200 hover:shadow-xl dark:shadow-none',
        className
      )}
    >
